...
alter sequence auth_user_user_id_seq restart with 4;
...
alter sequence auth_role_role_id_seq restart with 4;
...
alter sequence auth_res_res_id_seq restart with 9;
